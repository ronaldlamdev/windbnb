  ...
  return (
    <div>
      ...
      <div className='mt-3 w-full flex justify-between items-center'>
        <span><span className='px-2 py-[6px] border text-[.75rem] font-bold border-[#4F4F4F] rounded-2xl'>{superHost}</span> <span className='font-medium text-[#828282] text-sm'>{type} . {beds} beds</span></span>
